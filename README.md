# Cloud Computing Predict For The Purpose of Architecting and Building an End-to-End Portfolio Web-App With Automated Email Reply (AWS)

#### This Was Originally An EXPLORE AI Academy Cloud Computing Predict Which was Later Adopted As My Portfolio Website
## Overview

In this project, I made use of Python and AWS to create an intelligent data science portfolio website. At a high-level, the website will be hosted in a serverless manner on AWS; showcasing my amazing data engineering projects.
<p align="center">
